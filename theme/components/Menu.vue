<template>
    <div class="rootMenu">
        <div class="menu-outer" :class="isOpen && 'open'">
            <div class="menu-logo link-hover">
        ...
        <div class="menu-main">
            <div class="menu-items">
                <p class="menu-item link-hover" v-for="(item, index) in menuItems" data-index="translateY(0em)">{{ item.name }}</p>
                <div data-index="translateY(0em)"></div>
            </div>
            <div class="menu-author">
                <img class="menu-author-avatar" :src="author.avatar" alt="">
                <section class="menu-author-about">{{author.about}}</section>
            </div>
        </div>
    </div>
</template>
